...
class TestMLModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.X_train = train_df.drop('Clicked on Ad', axis=1)
        cls.y_train = train_df['Clicked on Ad']
        cls.X_test = test_df.drop('Clicked on Ad', axis=1)
        cls.y_test = test_df['Clicked on Ad']
